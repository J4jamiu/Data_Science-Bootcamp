...
#To validate the trigger is workin as expected, insert below into the employees table

INSERT employees VALUES ('999904', '1970-01-31', 'John', 'Johnson', 'M', '2023-03-28');  

#Use below script to check:
SELECT  *  FROM  employees ORDER BY emp_no DESC;

#To drop Trigger use : DROP TRIGGER trigger_name;